    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <nav className="border-b border-gray-800 bg-black/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <a href="/profile" className="text-2xl font-bold gradient-text">
              Next Chapter
            </a>
            <div className="flex gap-4">
              ...
              <a href="/profile/messages">
                <Button variant="ghost" className="border-b-2 border-athlete-green">
                  Messages
                </Button>
              </a>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex items-center gap-3 mb-6">
          <MessageCircle className="h-8 w-8 text-athlete-green" />
    ...
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-athlete-green mx-auto mb-4"></div>
